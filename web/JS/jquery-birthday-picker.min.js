$(function (e) {
    ...
    updateTheBirthDayValue = function (e, a, t, r, n) {
        ...
        for (var u = h; u >= c; u--)
            e("<option></option>").attr("value", u).text(u).appendTo(d);
        for (var u = 0; 11 >= u; u++)
            e("<option></option>").attr("value", u + 1).text(a[i.monthFormat][u]).appendTo(p);
        for (var u = 1; 31 >= u; u++) {
            var v = 10 > u ? "0" + u : u;
        ...
        o.on("change", function () {
            ...
            if (selectedYear > r) {
                if (t > n)
                    for (; t > n; )
                        p.children(":last").remove(), t--
            } else
                for (; 12 > t; )
                    e("<option></option>").attr("value", parseInt(t) + 1).text(a[i.monthFormat][t]).appendTo(p), t++;
            var l = s.children(":last").val(), o = new Date(selectedYear, selectedMonth, 0).getDate();
            if (l > o)
                for (; l > o; )
                    s.children(":last").remove(), l--;
            else if (o > l)
                for (; o > l; ) {
        ...
        maxAge: 100, minAge: 0, maxYear: r, dateFormat: "middleEndian", monthFormat: "number", placeholder: !0, defaultDate: !1, sizeClass: "span2", callback: !1
    }
}(jQuery));